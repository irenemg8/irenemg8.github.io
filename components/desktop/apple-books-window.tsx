...
import { X, Minus, Square, Search, Grid3X3, List, Book, ExternalLink, Github } from 'lucide-react'
import { ProjectFlipbook } from './project-flipbook'
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            {/* Content Area */}
            <div className="flex-1 overflow-auto p-6 bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
              {viewMode === 'grid' ? (
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                  {filteredProjects.map((project) => (
                    ...
                    >
                      <div className="relative">
                        {/* Book Cover */}
                        <div className="aspect-[3/4] bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg shadow-lg overflow-hidden relative transform group-hover:rotate-3 transition-transform duration-300">
                          <img
                            src={project.image}
                            alt={project.title}
                          ...
                          {/* Book spine effect */}
                          <div className="absolute left-0 top-0 bottom-0 w-2 bg-black bg-opacity-20 rounded-l-lg" />
                        ...
                        <div className="mt-3 text-center">
                          ...
                          <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">{project.date}</p>
                ...
                <div className="space-y-4">
                  {filteredProjects.map((project) => (
                    <motion.div
                      key={project.id}
                      whileHover={{ x: 5 }}
                      className="flex items-center space-x-4 p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-md transition-shadow cursor-pointer border border-gray-200 dark:border-gray-700"
                      onClick={() => setSelectedBook(project)}
                    >
                      <div className="w-16 h-20 bg-gradient-to-br from-blue-500 to-purple-600 rounded flex-shrink-0 overflow-hidden">
                        <img
                          src={project.image}
                          alt={project.title}
                          className="w-full h-full object-cover"
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center space-x-2">
                          ...
                          {project.priority && <span className="text-yellow-500">⭐</span>}
                        </div>
