    ...
    >
      <div className="w-full max-w-5xl h-[600px] bg-gray-50 dark:bg-gray-900 rounded-lg shadow-2xl overflow-hidden">
        ...
        <div className="bg-gradient-to-b from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-800 px-4 py-3 flex items-center justify-between">
          ...
          <h2 className="text-sm font-medium text-gray-700 dark:text-gray-300">{t('messages.title')}</h2>
          <div className="w-16" />
        </div>
          ...
          <div className="w-80 border-r border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 flex flex-col">
            ...
            <div className="p-3 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-between mb-3">
                <span className="text-xs text-blue-500 cursor-pointer hover:text-blue-600">{t('messages.edit')}</span>
              ...
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">{t('messages.title')}</h1>
              <input
                type="text"
              ...
              <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">{t('messages.online')}</p>
                  </div>
                </div>
                <button className="text-blue-500 hover:text-blue-600">
